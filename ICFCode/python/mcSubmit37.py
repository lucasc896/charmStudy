...
if len(commands.getoutput("echo $_CONDOR_SCRATCH_DIR")) > 0 :
  if outDir[0:2] == "..": outDir = outDir[1:]
  outDir = commands.getoutput("echo $_CONDOR_SCRATCH_DIR")+"/"+outDir
ensure_dir(outDir)
...
anal_ak5_caloMC           =Analysis("AK5Calo", outDir)
